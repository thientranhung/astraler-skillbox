...
// NewAppResetAllHandler returns a handler for app.resetAll. resetFn must close
// the DB connection and delete the database file. Electron triggers app.relaunch()
